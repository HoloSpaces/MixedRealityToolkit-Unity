...
namespace Microsoft.MixedReality.Toolkit.Editor
{
    ...
    public abstract class BaseMixedRealityToolkitConfigurationProfileInspector : BaseMixedRealityProfileInspector
    {
        ...
        protected void ApplyDataProviderConfiguration(
           ...
           SerializedProperty customizedRuntimePlatform,
           SerializedProperty runtimeModes)
        {
            if (type != null)
            {
                ...
                if (dataProviderAttribute != null)
                {
                    ...
                    if (dataProviderAttribute.CustomizedRuntimePlatforms != null && dataProviderAttribute.CustomizedRuntimePlatforms.Length > 0)
                    {
                        int arrayLength = dataProviderAttribute.CustomizedRuntimePlatforms.Length;
                        customizedRuntimePlatform.arraySize = arrayLength;
                        for (int i = 0; i < arrayLength; i++)
                        {
                            ...
                            arrayEntry.stringValue = dataProviderAttribute.CustomizedRuntimePlatforms[i].AssemblyQualifiedName;
                        }
                    } 
