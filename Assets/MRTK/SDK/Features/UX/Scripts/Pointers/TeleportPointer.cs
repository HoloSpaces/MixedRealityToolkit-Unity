                        ...
                        else if (canMove)
                        {
                            ...
                            if (offsetRotationAngle > 0)
                            {
                                ...
                                if (offsetRotationAngle < 2 * rotateActivationAngle)
                                {
                                    ...
                                    CoreServices.TeleportSystem?.RaiseTeleportStarted(null, new BackStepHotSpot(MixedRealityPlayspace.Position, cameraTransform.rotation.eulerAngles.y + (angle >= 0.0f ? rotationAmount : -rotationAmount)));
                                }
