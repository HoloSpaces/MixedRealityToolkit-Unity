...
public class DebugUIBuilder : MonoBehaviour
{
  ...
  [SerializeField]
  private RectTransform buttonPrefab = default;
  [SerializeField]
  private RectTransform labelPrefab = default;
  [SerializeField]
  private RectTransform sliderPrefab = default;
  [SerializeField]
  private RectTransform dividerPrefab = default;
  [SerializeField]
  private RectTransform togglePrefab = default;
  [SerializeField]
  private RectTransform radioPrefab = default;

  [SerializeField]
  private GameObject uiHelpersToInstantiate = default;

  [SerializeField]
  private Transform[] targetContentPanels = default;
  ...
  [SerializeField]
  private List<GameObject> toEnable = default;
  [SerializeField]
  private List<GameObject> toDisable = default;
