...
namespace Microsoft.MixedReality.Toolkit.Experimental
{
    ...
    public class BaseServiceManager : MonoBehaviour, IMixedRealityServiceRegistrar
    {
        ...
        /// <inheritdoc />
        public bool RegisterService<T>(Type concreteType, IPlatformSupport[] supportedPlatforms = null, params object[] args) where T : IMixedRealityService
        {
        ...
        private T ActivateInstance<T>(Type concreteType, IPlatformSupport[] supportedPlatforms = null, params object[] args) where T : IMixedRealityService
        {
        ...
        protected virtual void Initialize<T>(Type concreteType, IPlatformSupport[] supportedPlatforms = null, params object[] args) where T : IMixedRealityService
        {
