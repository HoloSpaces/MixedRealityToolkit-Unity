...
namespace HoloSpaces.MixedReality.Input
{
    ...
    public class OculusQuestMotionController : GenericOculusAndroidController
    {
        ...
        public override MixedRealityInteractionMapping[] DefaultLeftHandedInteractions => new[]
        {
            ...
            new MixedRealityInteractionMapping(12, "Button.Start Press", AxisType.Digital, DeviceInputType.ButtonPress, new MixedRealityInputAction(2, "Menu", AxisType.Digital), KeyCode.JoystickButton6),
